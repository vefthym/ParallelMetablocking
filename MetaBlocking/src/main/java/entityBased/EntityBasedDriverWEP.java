...
public class EntityBasedDriverWEP {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(entityBased.EntityBasedDriverWEP.class);

		conf.setJobName("Entity Based WEP");
...
//		conf.setMapperClass(entityBased.EntityBasedMapperFromCompressedNPClean.class); //Clean-Clean ER
		conf.setReducerClass(entityBased.EntityBasedReducerWEP.class);
