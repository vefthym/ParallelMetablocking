...
public class EntityBasedDriverWNPEJS {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(entityBased.EntityBasedDriverWNPEJS.class);

		conf.setJobName("Entity Based WNP EJS");
...
//		conf.setMapperClass(entityBased.EntityBasedMapperFromCompressedNPClean.class); //clean-clean
		conf.setReducerClass(entityBased.EntityBasedReducerWNPEJS.class);
