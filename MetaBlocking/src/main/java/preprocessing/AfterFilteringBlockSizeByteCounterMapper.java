...
public class AfterFilteringBlockSizeByteCounterMapper extends MapReduceBase implements Mapper<VIntWritable, VIntArrayWritable, VIntWritable, VIntWritable> {
