...
public class BlocksFromEntityIndexMapper extends MapReduceBase implements Mapper<VIntWritable, VIntArrayWritable, VIntWritable, VIntWritable> {
	 ...
	 * @param output key: a block id (each element of the input value array) - value: an entity id of this block (the input key)  
	 */
	public void map(VIntWritable key, VIntArrayWritable value,
		...
		VIntWritable [] Bi = value.get(); //the blocks of this entity
