...
import advanced.CEPFinalMapperNew.OutputData;

public class CEPFinalMapperOnlyNewEJS extends MapReduceBase implements Mapper<VIntWritable, Text, Text, DoubleWritable> {
