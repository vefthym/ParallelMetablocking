...
public class PNPMapper extends MapReduceBase implements Mapper<Text, DoubleWritable, VIntWritable, Text> {
	 ...
	 * @param output key:i value:j,wij and NOT the inverse (key:j value:i,wij) 
	 */
	public void map(Text key, DoubleWritable value,
		...
		i.set(Integer.parseInt(comparison[0])); //assuming i comes from the seed partition
