...
public class PWNPDriver {

	public static void main(String[] args) {
		JobClient client = new JobClient();
		JobConf conf = new JobConf(blockingGraphPruning.PWNPDriver.class);
		
		conf.setJobName("PWNP");
		...
		FileOutputFormat.setOutputPath(conf, new Path(args[1])); //PWNP
