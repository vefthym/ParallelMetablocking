...
public class AverageWeightEJSDriver extends Configured {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(fromExtendedInput.AverageWeightEJSDriver.class);
		...
		conf.setMapperClass(fromExtendedInput.AverageWeightEJSMapper.class);
		...
		try {								
			...
			double totalWeight = counters.findCounter(fromExtendedInput.AverageWeightEJSMapper.Weight.WEIGHT_COUNTER).getCounter() / 1000.0;			
