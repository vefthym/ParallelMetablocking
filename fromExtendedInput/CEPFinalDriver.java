...
public class CEPFinalDriver {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(fromExtendedInput.CEPFinalDriver.class);
		...
		try{
            ...
            if (extraElements > 0) { //use a reducer  to skip the extra elements         	
            	...
            	conf.setMapperClass(fromExtendedInput.CEPFinalMapper.class);
            	...
            	conf.setMapperClass(fromExtendedInput.CEPFinalMapperOnly.class);    		
