...
public class CEPFinalEJSDriver {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(fromExtendedInput.CEPFinalEJSDriver.class);
		...
		try{
            ...
            if (extraElements > 0) { //use a reducer  to skip the extra elements         	
            	...
            	conf.setMapperClass(fromExtendedInput.CEPFinalEJSMapper.class);
            	...
            	conf.setMapperClass(fromExtendedInput.CEPFinalEJSMapperOnly.class);    		
