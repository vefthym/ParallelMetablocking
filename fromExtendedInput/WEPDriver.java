...
public class WEPDriver extends Configured {
	...
	public static void main(String[] args) {
		...
		JobConf conf = new JobConf(fromExtendedInput.WEPDriver.class);
		...
		conf.setMapperClass(fromExtendedInput.WEPMapperOnly.class);		
	//	conf.setReducerClass(fromExtendedInput.WEPReducer.class);		
