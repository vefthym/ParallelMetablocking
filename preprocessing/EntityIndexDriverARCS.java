...
import preprocessing.EntityIndexReducerARCS.OutputData;

public class EntityIndexDriverARCS {

	public static void main(String[] args) {
		JobClient client = new JobClient();
		JobConf conf = new JobConf(preprocessing.EntityIndexDriverARCS.class);

		conf.setJobName("Entity Index (With Block Filtering) for ARCS");
		...
		conf.setMapperClass(preprocessing.EntityIndexMapperARCS.class);		
		conf.setReducerClass(preprocessing.EntityIndexReducerARCS.class);
